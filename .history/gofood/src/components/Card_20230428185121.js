...
const handleAddToCart = () => {
  ...
  if(food !== []){
    if(food.size === size){
      dispatch({type:"UPDATE",id:foodItem._id,price:finalPrice,qty:qty,food:food});
      return
    }
  }
   dispatch({type:"ADD",id:props.foodItem.id,name:props.foodItem.name,price:finalPrice,qty: qty,size: size})
   console.log(data)
}
